...
urlpatterns = [
    ...
    path('accounts/', views.AccountListCreateAPI.as_view(), name='account_details'),
    ...
    path('transaction-details/<int:pk>', views.TransactionDeleteAPI.as_view(), name='transaction_details'),
